    ...
    try:
        async with async_session_maker() as session:
            ...
            stmt = text(
                ...
                f"{M_REPORT_TGF.rgf.key} ||' '|| "
                f"{M_REPORT_TGF.inf_report.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_ekat.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_tmn.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_hmao.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_kras.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_more.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_kurgan.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_novo.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_omsk.key} ||' '|| "
                f"{M_REPORT_TGF.tgf_ynao.key} ||' '|| "
                f"{M_REPORT_TGF.zsniigg_report.key} ||' '|| "
                f"{M_REPORT_TGF.folder_name.key} ||' '|| "
